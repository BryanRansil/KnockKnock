...
public class GameGenerator : MonoBehaviour
{
    ...
    public List<GameObject> terrain_prefabs;
    ...
    public void Populate(Vector3 worldPosition, IARFrame currentFrame)
    {
        ...
        _terrain = GameObject.Instantiate(terrain_prefabs[UnityEngine.Random.Range(0, 3)], center, Quaternion.identity);
